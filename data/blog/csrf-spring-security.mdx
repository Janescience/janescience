...
layout: PostSimple
featureImage: "/static/images/blog/csrf-spring-security/cover.jpg"
---

<center>![Auth API Spring Boot](/static/images/blog/csrf-spring-security/cover.jpg)</center>
<center className="text-xs">
  ขอบคุณรูปภาพจาก
  [https://blog.guardrails.io](https://blog.guardrails.io/wp-content/uploads/2022/07/CSRF-1024x600.jpg)
</center>
