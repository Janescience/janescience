...
<center className="text-xs">
  ขอบคุณรูปภาพจาก
  [https://miro.medium.com](https://miro.medium.com/v2/resize:fit:800/0*WddOBoMIYbSPNGSD.png)
</center>
...
<div className="w-3/4">
![Signup](/static/images/blog/auth-springsecurity-jwt/signup.png)
</div>
...
<div className="w-3/4">
![Signup](/static/images/blog/auth-springsecurity-jwt/env-variable.png)
</div>

2.2 เขียน Script รับค่า Token แล้วนำไป Set ให้กับตัวแปร `{{AccessToken}}` ทุกครั้งที่ Signin สำเร็จ
<div className="w-3/4">
![Signup](/static/images/blog/auth-springsecurity-jwt/test-script.png)
</div>
...
<div className="w-3/4">
![Signup](/static/images/blog/auth-springsecurity-jwt/signin.png)
</div>
...
<div className="w-3/4">
![Get User](/static/images/blog/auth-springsecurity-jwt/get-user.png)
</div>

Postman จะ Auto เพิ่ม Header ให้เลย ถ้าเราใส่ข้อมูลใน Authorization
<div className="w-3/4">
![Get User](/static/images/blog/auth-springsecurity-jwt/header.png)
</div>

ถ้า Token เราหมดอายุ หรือ ไม่ได้ส่ง Token ไปด้วย หรือ Token ผิด ก็จะได้ Error 401 - Unauthorized
<div className="w-3/4">
![401](/static/images/blog/auth-springsecurity-jwt/401.png)
</div>
