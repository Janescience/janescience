...
_<center>ขอบคุณรูปภาพจาก (https://scdn.line-apps.com/n/line_notice/img/og_160829/og_fb.png) </center>_
...
### 3. เลือก "Add Service" เนื่องจากของผมเคยสร้างไว้แล้ว ผมจะสร้างเพิ่ม
...
user ต้องทำการ authorize มาที่ service ของเราก่อน เพื่อบอกว่าเราจะใช้ service การแจ้งเตือนของคุณนะ
การ authorize จะทำผ่าน browser เท่านั้น เมื่อ authorize สำเร็จ line notify จะ redirect ไปที่ callback url ที่เราระบุไว้
หลังจาก authorize จะสามารถร้องขอ token ได้ เพื่อนำไปใช้ในการแจ้งเตือนแต่ล่ะครั้ง

## Access Token

หลังจาก authorize แล้ว เราจะให้ไปร้องขอ token ในขั้นตอนการ redirect เลย โดย backend ของผมเป็น express.js

### /services/line.js

สร้าง service สำหรับร้องขอ token
...
1. สร้างปุ่มหรือลิงก์อะไรก็ได้ให้ user กด เพื่อ authorize code ตัวอย่างของผม frontend จะเป็น vue
