---
title: Authentication ด้วย Spring Security & JWT และ Run ด้วย Docker
date: "2023-03-11"
tags: ["springboot","jwt","docker"]
draft: false
summary: ""
layout: PostSimple
featureImage: "/static/images/blog/auth-springsecurity-jwt-docker/cover.png"
---

<center>![Auth API Spring Boot](/static/images/blog/auth-springsecurity-jwt-docker/cover.png)</center>*<center className="text-xs">
  ขอบคุณรูปภาพจาก
...
![ER Diagram](/static/images/blog/auth-springsecurity-jwt-docker/er-diagram.png)
...
![Spring Init](/static/images/blog/auth-springsecurity-jwt-docker/spring-init.png)
...
เรา Setup ให้สามารถ Run ผ่าน Docker ได้แล้วแถมได้ PostgresSQL มาด้วย 
Step นี้เราจะ Config ให้สามารถ Run project นี้ได้ด้วยเครื่องของเราเอง และเชื่อมต่อ Database ไปยัง PostgresSQL
...
ถึงเวลาเริ่มเขียน Code จริงจัง DB ของผมจะมีแค่ 2 ตาราง User , MemberType 
เก็บข้อมูลของ User และแยกประเภทได้ตามเงินเดือน
        ...
        return new OpenAPI()
            ...
            .externalDocs(
                new ExternalDocumentation()
                    ...
                    .url("https://janescience.com/blog/auth-springsecurity-jwt-docker"))
...
![Swagger UI](/static/images/blog/auth-springsecurity-jwt-docker/swagger-1.png)

<br/>

![Swagger UI](/static/images/blog/auth-springsecurity-jwt-docker/swagger-2.png)
