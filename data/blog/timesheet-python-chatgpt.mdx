...
date: "2023-02-21"
tags: ["excel", "timesheet", "python","chatgpt"]
draft: false
...
layout: PostSimple
featureImage: "/static/images/blog/timesheet-python-chatgpt/cover.png"
---

<center>![Timesheet Cover](/static/images/blog/timesheet-python-chatgpt/cover.png)</center>
...
เอาง่ายๆว่ารู้สึกไม่คุ้มที่จะเขียนโปรแกรมขึ้นมาเพื่อทำสิ่งนี้ ซึ่งผมใช้ ChatGPT ช่วยในหลายเรื่องจริงๆ โดยเฉพาะผมสงสัยอะไร หรือ อยากทำอะไรที่ไม่เคยทำมาก่อน อีกนานผมได้เสียเงินแน่ๆ 🤣
