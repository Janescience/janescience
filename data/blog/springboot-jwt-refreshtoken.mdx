...
<center>![Auth API Spring Boot](/static/images/blog/springboot-jwt-refreshtoken/cover.jpeg)</center>
<center className="text-xs">
  ขอบคุณรูปภาพจาก [https://i.ytimg.com](https://i.ytimg.com/vi/ahDQI7msr0A/maxresdefault.jpg)
</center>
